...
L(1) = Link('alpha', alpha1,'a', a1,'d', d1, 'offset', 0*pi/180,'standard');   
...
L(6) = Link('alpha', alpha6,'a', a6,'d', d6, 'offset', ((-53.27)*(pi/2))/90, 'standard');   
L(7) = Link('alpha', alpha7,'a', a7,'d', d7, 'offset',pi/2,'standard'); 

Spider=SerialLink(L,'name','Hexapod Leg 3');
Spider.teach('rpy');