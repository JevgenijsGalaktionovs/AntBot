...
class LegConsts(object):
    ...
    def __init__(self, x_off, y_off, z_off, ang_off, side, leg_nr):
        ...
        self.t_ang_off = -25.90 * pi / 180   # Angular offset of Tibia    42.24       -32.264
        self.c_len     =  66.50              # Link length of Coxa  (mm)
        self.f_len     =  144.4              # Link length of Femur (mm)        92.17
        self.t_len     =  287#236.5          # Link length of Tibia (mm)        193.66
...
# Function for measuring contact
    ...
    stairs = [0.1495996501709427,   0.5516007613995267,  -1.8926273690857194, 
             -0.1495996501709427,   0.550066406013158,   -1.8849555921538759, 
              0.30610389958054424,  0.4610737936037765,  -1.6256495318575752, 
             -0.3091726103532812,   0.4580050828310392,  -1.6256495318575752, 
              0.30917261035328153, -0.04833219467061203, -1.2574042391291016, 
             -0.31224132112601843, -0.04526348389787476, -1.255869883742733]
    C.positionAll(stairs)
